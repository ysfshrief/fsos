  ...
  return (
    <div>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <Link href="/portal/admin/timetables"
          className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:-translate-y-0.5 hover:shadow-md transition">
          <div className="text-3xl mb-2">📅</div>
          <div className="font-bold text-gray-800 mb-1">{t('manageTimetables')}</div>
          <div className="text-xs text-gray-500">جداول الفصول والمدرسين وعدد الحصص</div>
        </Link>
